...
% varrange  - [0] the range for variance within the max to choose the dimension from
...
% sample    - [0] the number of samples to use to estimate the variance 
...
if ~exist('sample','var') || isempty(sample), sample = 0; end;
